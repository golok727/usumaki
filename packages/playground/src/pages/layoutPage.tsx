...
import { UzElement, type UzViewElement } from 'uzumaki';
import { C } from '../theme';
...
const SECTIONS: Section[] = [
  { id: 'justify', label: 'Flexbox — justify' },
  { id: 'items', label: 'Flexbox — items' },
  { id: 'radius', label: 'Per-corner radius' },
  { id: 'borders', label: 'Per-side borders' },
  { id: 'opacity', label: 'Opacity scale' },
  { id: 'transforms', label: 'Transforms' },
  { id: 'gap', label: 'Dynamic gap / padding' },
  { id: 'buttons', label: 'Buttons' },
  { id: 'nesting', label: 'Deep nesting' },
  { id: 'cursors', label: 'Cursor kinds' },
  { id: 'display', label: 'display prop' },
    ...
    <>
      {open && (
        <view
          ...
          bottom={0}
          onClick={(ev) => {
            if (ev.target instanceof UzElement && ev.target.id === backdropId)
              onClose();
          }}
        />
      )}
      ...
      >
        ...
        <button
          ...
          justify="center"
        >
          <text fontSize={13} fontWeight={800} color={C.accentHi}>
            {open ? 'Close' : 'Sections'}
          </text>
        </button>
      </view>
...
export function LayoutPage() {
  ...
  const sectionRefs = useRef<Record<string, UzViewElement | null>>({});
  const refSetters = useRef<Record<string, (el: UzViewElement | null) => void>>(
    {},
  );
    ...
    <>
      ...
      >
        ...
        <view display="flex" flexDir="col" gap={24} p={24}>
          <view ref={setRef('justify')} display="flex" flexDir="col" gap={12}>
            <view fontSize={14} fontWeight={700} color={C.text}>
          ...
          <view ref={setRef('items')} display="flex" flexDir="col" gap={12}>
            <text fontSize={14} fontWeight={700} color={C.text}>
          ...
          <view ref={setRef('radius')} display="flex" flexDir="col" gap={12}>
            <text fontSize={14} fontWeight={700} color={C.text}>
          ...
          <view ref={setRef('borders')} display="flex" flexDir="col" gap={12}>
            <view fontSize={14} fontWeight={700} color={C.text}>
              Per-side borders
            </view>
            <view display="flex" flexDir="row" gap={12} items="center">
          ...
          <view ref={setRef('opacity')} display="flex" flexDir="col" gap={12}>
            <view fontSize={14} fontWeight={700} color={C.text}>
              Opacity scale
            </view>
          ...
          >
            <view display="flex" flexDir="col" gap={4}>
              ...
              <view fontSize={12} color={C.textMuted}>
                translate, rotate, scale, and hover:scale without changing
                layout
              </view>
            </view>
            <view
          ...
          <view ref={setRef('gap')} display="flex" flexDir="col" gap={12}>
          ...
          <view ref={setRef('buttons')} display="flex" flexDir="col" gap={12}>
            <view display="flex" flexDir="col" gap={4}>
              <view fontSize={14} fontWeight={700} color={C.text}>
                Buttons
              </view>
          ...
          <view ref={setRef('nesting')} display="flex" flexDir="col" gap={12}>
            <text fontSize={14} fontWeight={700} color={C.text}>
          ...
          <view ref={setRef('cursors')} display="flex" flexDir="col" gap={10}>
            <view display="flex" flexDir="row" items="center" gap={8}>
              <text fontSize={14} fontWeight={700} color={C.text}>
                Cursor kinds
              </text>
          ...
          <view ref={setRef('display')} display="flex" flexDir="col" gap={10}>
          ...
          <view ref={setRef('inline')}>
            <InlineFlowDemo />
          </view>

          <Divider />

          <view ref={setRef('textalign')}>
            <TextAlignDemo />
          </view>
